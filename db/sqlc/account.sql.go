...
INSERT INTO accounts (
  ...
  $1, $2, $3, $4, $5, $6, $7
) RETURNING id, user_id, category_id, title, type, value, date, description, created_at
`
...
SELECT id, user_id, category_id, title, type, value, date, description, created_at FROM accounts
WHERE id = $1 LIMIT 1
`
